import 'dart:convert';
import 'package:carrot_clone/repositories/local_storage_repository.dart';
...
class ContentsRepository extends LocalStorageRepository {
  ...
  void addDataList(Map<String, dynamic> other) {
    data.addAll(other);
  }
  ...
  void updateMyFavoriteContent(List favoriteContentsList) {
