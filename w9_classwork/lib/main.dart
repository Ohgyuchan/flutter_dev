...
final guestRef = FirebaseFirestore.instance.collection('guestbook');
...
class GuestBookMessage {
  GuestBookMessage(
      {required this.docId, required this.name, required this.message, required this.userId, required this.timestamp});
  final String docId;
  final String name;
